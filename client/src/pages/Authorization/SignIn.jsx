...
const SignIn = () => {
    ...
    return <>
        <div className="sign-up-form-container flex">
            ...
            <div className="sign-up-form-container w-full flex flex-col gap-y-4 p-4 justify-center items-center">
                <p className="text-nowrap self-end">New to Dribbble ? <Link to={"/sign-up"} className="text-blue-900">Sign Up</Link></p>
	...
	c-2.25,2.39-3.43,5.6-3.25,8.88L387.65,361.66z"
                    ...
                    <button className="px-4 py-2 rounded-md bg-pink-500 text-white font-bold">
                        Login
                    </button>
                </form>
